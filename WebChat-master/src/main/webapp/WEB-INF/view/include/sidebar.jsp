    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
        ...
        <ul class="am-list admin-sidebar-list">
            ...
            <li class="admin-parent">
                <a class="am-cf am-collapsed" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-cogs"></span> 设置 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
        ...
        <c:if test="${flag eq 6}">
            <ul class="am-list admin-sidebar-list">
                <li><a href="${ctx}/chat"><span class="am-icon-commenting"></span> 聊天</a></li>
                <li><a href="${ctx}/selectAllToAdmin"><span class="am-icon-inbox"></span> 系统日志<span class="am-badge am-badge-secondary am-margin-right am-fr">⭐</span></a></li>
                <li><a href="${ctx}/selectAllUserToAdmin"><span class="am-icon-inbox"></span> 用户管理<span class="am-badge am-badge-secondary am-margin-right am-fr">⭐</span></a></li>
            </ul>
        </c:if>
